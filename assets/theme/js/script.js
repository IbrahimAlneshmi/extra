...
(function() {
    ...
    k(function() {
        ...
        window.addEventListener("scroll", function() {
            ...
            if (t) {
                ...
                b ? c != t.fixed && (k ? (t.fixed = c,
                t.elm.classList.toggle("is-fixed")) : l = setTimeout(function() {
                    t.fixed = c;
                    t.elm.classList.toggle("is-fixed")
                }, 40)) : (t.fixed = !1,
                t.elm.classList.remove("is-fixed"))
            }
        });
        if (v)
                ...
                var a = function() {
                    ...
                    d.forEach(function(d) {
                        var l = d.offsetHeight
                          , f = e(d);
                        (f + l >= a && f - 50 <= c || b(d)) && d.classList.contains("hidden") && (d.classList.remove("hidden"),
                        d.classList.add("animate__fadeInUp"),
                        d.classList.add("animate__delay-1s"),
                        d.addEventListener("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
    ...
    document.querySelectorAll("nav.navbar").length && (w = f(document.querySelector("nav.navbar")),
        ...
        if (!m) {
            var a = function(a) {
              ...
              , b = function(b) {
                ...
                if (e) {
                    if (-1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"),
                    -1 !== e.indexOf("vimeo")) {
                ...
                k.addEventListener("click", function(b) {
                    "VIDEO" !== b.target.tagName && (e ? (-1 !== e.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"),
                    -1 !== e.indexOf("vimeo") && f.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(),
    ...
    document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function(a) {
        a.addEventListener("click", function() {
            ...
            !e.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ? (d.classList.remove("mbri-arrow-up"),
            d.classList.add("mbri-arrow-down")) : (d.classList.remove("mbri-arrow-down"),
...
!function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/builder/mac-website-builder.html">Website Builder for Mac</a> Mobirise v5.9.0 <a href="https://mobirise.com/website-builder/nonprofit.html">website builder for nonprofit</a>';
