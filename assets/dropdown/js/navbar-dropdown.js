...
(function() {
    function b(a) {
        ...
        Array.from(document.querySelector(".navbar-dropdown").querySelectorAll('.navbar-toggler[aria-expanded="true"]')).forEach(function(a) {
            var b = a.querySelector(a.getAttribute("data-target"));
            b && (b.classList.remove("in"),
    ...
    document.querySelector("html").classList.contains("is-builder") || document.addEventListener("click", function(a) {
        ...
        if (!a.classList.contains("nav-link") && !a.parentNode.classList.contains("nav-link")) {
            ...
            (window.matchMedia("(max-width: 991px)").matches || c) && (e && !a.closest(".navbar-collapse") || g) && new bootstrap.Collapse(b)
        }
    });
